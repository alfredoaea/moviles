		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-lg-4 p-b-50">
					...
					¿Alguna pregunta? Háganos saber en la tienda en el piso 8, 379 Hudson St, Nueva York, NY 10018 o llámenos al (+1) 96716 6879
					</p>
					<!-- https://facebook.com/lexstore -->
					<div class="p-t-27">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos los Derechos Reservados | Esta página está hecha con <i class="fa fa-heart-o" aria-hidden="true"></i> por <a href="https://colorlib.com" target="_blank">Colorlib</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<!-- boton volver arriva -->
	<div class="btn-back-to-top" id="myBtn" title="Regresa al Inicio">
				...
				<div class="row">
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							...
							<!-- iconos de redes en modo vista rapida -->
							<div class="flex-w flex-m p-l-100 p-t-40 respon7">
								<div class="flex-m bor9 p-r-10 m-r-11">
									<a href="#" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 js-addwish-detail tooltip100" data-tooltip="Añadir a la lista de Deseos">
